...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'page_admin_settings_settings.tpl', 236, false),)), $this); ?>
<div class="row">
					...
					<div class="table-responsive">
						<table class="table table-striped">
							<tr>
								...
								<td>
									<div align="left">
										<input type="text" TABINDEX=1 class="form-control" id="template_title" name="template_title" value="<?php echo $this->_tpl_vars['config_title']; ?>
" />
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div align="left">
										<input type="text" TABINDEX=2 class="form-control" id="template_logo" name="template_logo" value="<?php echo $this->_tpl_vars['config_logo']; ?>
" />
							...
							<tr>
								...
								<td>
									<div align="left">
										<input type="text" TABINDEX=3 class="form-control" id="config_password_minlength" name="config_password_minlength" value="<?php echo $this->_tpl_vars['config_min_password']; ?>
" />
									</div>
							...
							<tr>
								...
								<td>
									<div align="left">
										<input type="text" TABINDEX=4 class="form-control" id="config_dateformat" name="config_dateformat" value="<?php echo $this->_tpl_vars['config_dateformat']; ?>
" />
							...
							<tr>
								...
								<td>
									<div align="left">
										<input type="text" TABINDEX=7 class="form-control" id="dash_intro_title" name="dash_intro_title" value="<?php echo $this->_tpl_vars['config_dash_title']; ?>
" />
									</div>
							...
							<tr>
								...
								<td>
									<div align="left">
										<input type="text" TABINDEX=12 class="form-control" id="banlist_bansperpage" name="banlist_bansperpage" value="<?php echo $this->_tpl_vars['config_bans_per_page']; ?>
" />
									</div>
...
?>
											<tr>
												<td><input type="text" class="form-control" name="bans_customreason[]" id="bans_customreason[]" value="<?php echo $this->_tpl_vars['creason']; ?>
"/></td>
											</tr>
