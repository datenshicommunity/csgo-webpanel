...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'page_admin_bans_protests_archiv.tpl', 148, false),)), $this); ?>
	...
	<div class="col-lg-12 grid-margin">
		<div class="card">
			<div class="card-body" id="add-group1">
				<h3>Ban Protests Archive <i class="btn btn-outline-primary btn-rounded btn-fw" style="width:20px;height:20px;padding:0px;line-height:18px;">Total Archive:<?php echo $this->_tpl_vars['protest_count_archiv']; ?>
</i></h3>
...
?>
						<tr style="cursor:pointer;" data-toggle="collapse" data-target="#expand_protestsa_<?php echo $this->_tpl_vars['protest']['pid']; ?>
" aria-expanded="false" aria-controls="collapseExample">
							<td class="toggler" style="border-bottom: solid 1px #ccc"><?php if ($this->_tpl_vars['protest']['archiv'] != 2): ?><a href="./index.php?p=banlist<?php if ($this->_tpl_vars['protest']['authid'] != ""): ?>&advSearch=<?php echo $this->_tpl_vars['protest']['authid']; ?>
...
&advType=ip<?php endif; ?>" title="Show ban"><?php echo $this->_tpl_vars['protest']['name']; ?>
							...
							<td style="border-bottom: solid 1px #ccc"><?php if ($this->_tpl_vars['protest']['authid'] != ""): ?><?php echo $this->_tpl_vars['protest']['authid']; ?>
...
" style="padding:0;" colspan="4">
								<div class="collapse" id="expand_protestsa_<?php echo $this->_tpl_vars['protest']['pid']; ?>
" data-parent="#protestsa">
