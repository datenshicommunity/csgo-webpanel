...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'page_admin_admins_add.tpl', 234, false),)), $this); ?>
...
<b><i>(Group)</i></b></td>
								...
								<div class="form-check">
									<label class="form-check-label">
									<input id="group[]" type="checkbox" name="group[]" vspace="5px" class="form-check-input" value="g<?php echo $this->_tpl_vars['group']['gid']; ?>
"> &nbsp;
									<i class="input-helper"></i></label>
								</div>
								</td>
...
?>
							<tr class="tablerow1">
								<td colspan="2" class="tablerow1" style="background:#fff;" id="sa<?php echo $this->_tpl_vars['server']['sid']; ?>
...
:<?php echo $this->_tpl_vars['server']['port']; ?>
								...
								<div class="form-check">
									<label class="form-check-label">
									<input id="servers[]" type="checkbox" name="servers[]" vspace="5px" class="form-check-input" value="s<?php echo $this->_tpl_vars['server']['sid']; ?>
"> &nbsp;
									<i class="input-helper"></i></label>
								</div>
						  		</td> 
