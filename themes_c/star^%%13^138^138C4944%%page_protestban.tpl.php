<?php /* Smarty version 2.6.31, created on 2021-12-21 17:20:29
					...
					<div class="row" id="steam.row">
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="SteamID" value="<?php echo $this->_tpl_vars['steam_id']; ?>
"/>
								</div>
							</div>
						</div>
					...
					<div class="row" id="ip.row" style="display:none;">
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="IP" value="<?php echo $this->_tpl_vars['ip']; ?>
"/>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<textarea name="BanReason" cols="30" rows="5" class="form-control"><?php echo $this->_tpl_vars['reason']; ?>
</textarea>
								</div>
							</div>
						</div>
