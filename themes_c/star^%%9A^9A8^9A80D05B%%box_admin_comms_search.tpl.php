...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'box_admin_comms_search.tpl', 190, false),)), $this); ?>
<div class="row">
...
:<?php echo $this->_tpl_vars['server']['port']; ?>
			...
			<div class="row mx-5 pb-3">
				...
				<div class="col-sm-9">
					<?php echo smarty_function_sb_button(array('text' => 'Search','onclick' => "search_blocks();",'class' => 'ok searchbtn','id' => 'searchbtn','submit' => false), $this);?>
