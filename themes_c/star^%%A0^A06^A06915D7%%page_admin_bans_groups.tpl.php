...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'page_admin_bans_groups.tpl', 50, false),)), $this); ?>
	...
	<div class="col-lg-12 grid-margin">
		<div class="card">
			<div class="card-body">
				...
				<?php else: ?>
				<p>All groups the player <?php echo $this->_tpl_vars['player_name']; ?>
